...
with open('/home/khalil/Bureau/python/Projet Python/Donnees_Projet_Python_DataC5.csv' , 'r') as f:  
        eleves=f.read().split("\n")
        del eleves[0]
Tab_eleve=[]
for eleve in eleves :
...
while True:
    ...
    if choix == '1':
        vi=input("Veuillez a pour les infos valides et b pour les infos invalide : ")
        if vi=='a':
